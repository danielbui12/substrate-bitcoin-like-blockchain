...
Great work completing step 6! 💪 You're almost at the finish line. Now, let's dive into step 7. Run this command to continue:  

```sh
git checkout step-7-client-sigscript
```